function source(e){
  ...
  $.getJSON(NewUrl,function(data){
    var urlid=data.taggedSections.VideoURL;
    console.log("inside getjson");
    // lecture_data += '<div id="vid" class="embed-responsive embed-responsive-16by9 mt-3 mb-4">';
    // lecture_data += '<iframe id="existing-iframe-example" width="560" height="315"  src="'+urlid+'" frameborder="0" style="border: solid 4px #37474F" allow="autoplay; encrypted-media" allowfullscreen></iframe>';
    // lecture_data += '</div>';
